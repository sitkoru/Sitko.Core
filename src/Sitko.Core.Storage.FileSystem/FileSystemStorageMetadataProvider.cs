...
{
    public FileSystemStorageMetadataProvider(IOptionsMonitor<TStorageOptions> storageOptions,
        IOptionsMonitor<FileSystemStorageMetadataModuleOptions<TStorageOptions>> options,
        ILogger<FileSystemStorageMetadataProvider<TStorageOptions>> logger) : base(options,
        storageOptions,
        logger)
    {
    }
