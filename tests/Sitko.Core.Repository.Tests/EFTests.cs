...
namespace Sitko.Core.Repository.Tests
{
    public class EFTests : BaseTest<EFTestScope>
    {
        ...
        [Fact]
        public async Task DisconnectedManyToMany()
        {
            var scope = await GetScopeAsync();
            BarModel? originalBar;
            using (var scope1 = scope.CreateScope())
        ...
        [Fact]
        public async Task DisconnectedManyToManyUpdateEntity()
        {
            var scope = await GetScopeAsync();
            BarModel? originalBar;
            using (var scope1 = scope.CreateScope())
        ...
        [Fact]
        public async Task DisconnectedManyToManyMultipleEntity()
        {
            var scope = await GetScopeAsync();
            BarModel? originalBar;
            using (var scope1 = scope.CreateScope())
        ...
        [Fact]
        public async Task DisconnectedManyToManyDeleteEntity()
        {
            var scope = await GetScopeAsync();
            BarModel? originalBar;
            using (var scope1 = scope.CreateScope())
